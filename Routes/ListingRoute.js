...
//index routes
Lrouter.get("/", isLoggedIn, wrapAsync(async (req, res) => {
...
//create route 
Lrouter.post("/addlistings", isLoggedIn, validateListing, wrapAsync(async (req, res, next) => {
...
//update
Lrouter.put("/updatelisting/:id", isLoggedIn, isOwner, validateListing, wrapAsync(async (req, res) => {
    let id = req.params.id;
...
//delete
Lrouter.delete("/delete/:id", isLoggedIn, isOwner, wrapAsync(async (req, res) => {
    let id = req.params.id;
